...
df = pd.read_csv("/users/davisturner/desktop/PriceCSVs/maize_variability_signal.csv", low_memory=False)
...
plt.tight_layout()
plt.savefig("/users/davisturner/desktop/PriceCSVs/signal_vs_cv_bar.png", dpi=150)
plt.close()
...
ax.legend()
plt.tight_layout()
plt.savefig("/users/davisturner/desktop/PriceCSVs/scatter_signal_cv.png", dpi=150)
plt.close()
